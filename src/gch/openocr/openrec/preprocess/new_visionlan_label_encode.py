...
class NewVisionLANLabelEncode(BaseRecLabelEncode):
    ...
    def __call__(self, data):
        ...
        change_id = sample(list(range(len_str)), 1)[0]
        ...
        data['label_res'] = label_res
        data['label_sub'] = label_sub
        data['label_id'] = change_id
        ...
        # Keep one-char samples without emitting empty-text warnings.
        if len(label_res) > 0:
